...
export const INITIAL_NODES: CanvasNode[] = [
  ...
  // Interactive Simulated Windows (Ported from Phantomat)
  {
    id: 'win-alacritty-terminal',
    title: 'alacritty — fastfetch & cross-chain logs',
    app: 'Alacritty',
    type: 'window',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: 'Fastfetch environment metrics and Aether cross-chain transaction logs.'
  },
  {
    id: 'win-neovim-code',
    title: 'nvim — ~/aether/execution_router.ts',
    app: 'Neovim',
    type: 'window',
    windowContent: 'code',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: 'Real-time smart contract spatial routing algorithm script.'
  },
  {
    id: 'win-btop-monitor',
    title: 'btop++ — Multi-chain RPC Latency & Cluster Stream',
    app: 'Btop',
    type: 'window',
    windowContent: 'btop',
    category: 'System',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: 'Live animated RPC latency bars across Solana, Arbitrum, Hyperliquid.'
  },
  {
    id: 'win-blender-3d',
    title: 'blender — 3D Liquidity Surface Simulation',
    app: 'Blender',
    type: 'window',
    windowContent: '3d',
    category: 'Graphics',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: '3D parametric torus rotating in real-time.'
  },
  {
    id: 'win-music-player',
    title: 'spotify — Daft Punk - Discovery (Focus Audio)',
    app: 'Spotify',
    type: 'window',
    windowContent: 'music',
    category: 'Media',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: 'Lossless audio streaming with live equalizer bars.'
  },
  {
    id: 'win-alpha-chat',
    title: 'discord — #aether-alpha-traders',
    app: 'Discord',
    type: 'window',
    windowContent: 'chat',
    category: 'System',
    ...
    valueUsd: 0,
    riskLevel: 'safe',
    strategy: 'Sub-second real-time cross-chain messaging stream.'
  }
];
